...
This repository contains a refactored and optimized version of the original
codebase which was originally released as RECON 1.01-1.05 and may be found
at http://eddylab.org/software/recon/.  Non-breaking maintenance updates
were also generated by Robert Hubley and released as RECON 1.06-1.08 and
may be found at ```http://www.repeatmasker.org/RECON-1.0#.tar.gz```
...
assistance of AI coding agents (Claude, GitHub Copilot).  It also contains
contributions by Robert Hubley, and Kate Newcomer.
