/*
 * msps.c  --  MSP data structure operations: implementation
 *
 * Contains the implementations of all functions whose prototypes live in
 * msps.h.  The data structure definitions (FRAG_t, IMAGE_t, MSP_t, etc.)
 * remain in msps.h.
 *
 * Author: Zhirong Bao
